...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [542] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_dotted_identifier_repeat1, 2), SHIFT_REPEAT(464),
  [545] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_with_snippet_expression, 1),
  [547] = {.entry = {.count = 1, .reusable = true}}, SHIFT(401),
  [549] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_order_null_direciton, 2, .production_id = 5),
  ...
  [559] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_sosl_query_body_repeat1, 1),
  [561] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_having_not_expression, 2),
  [563] = {.entry = {.count = 1, .reusable = true}}, SHIFT(456),
  [565] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_having_clause, 2),
  [567] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_order_expression, 3),
  ...
  [577] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_in_clause, 3),
